<template>
  <v-data-table v-if="serviceTypes"
    :headers="headers"
    :items="serviceTypes"
    sort-by="calories"
    :search="search"
...
...mapActions(["addServiceType","updateServiceType","deleteServiceType"]),
...
previewImage(event) {
    ...
    onUpload() {
      ...
      deleteItemConfirm () {
          //delete record
          console.log("What is this",this.editedItem)
this.deleteServiceType(this.editedItem.id)
      ...
      save () {
        if (this.editedIndex > -1) {
            ...
            console.log("what is ",this.editedItem)
   
        this.updateServiceType(this.editedItem)
        //   Object.assign(this.serviceTypes[this.editedIndex], this.editedItem)
        } else {
            //new 
         this.addServiceType(this.editedItem) 
        }
        this.close()
      },
    },
